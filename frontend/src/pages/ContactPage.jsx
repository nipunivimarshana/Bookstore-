      ...
      <div className="contact-container">
        <header className="contact-header">
          ...
          <p>
            ...
            need help with an order, or just want to share your thoughts, we're here to help. 
        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <div className="info-section">
              <h3>Email</h3>
              <p>support@bookstore.com<br />We respond within 24 hours</p>
            </div>
            ...
            <div className="info-section">
              <h3>Live Chat</h3>
              <p>Available 24/7 on our website<br />Instant support for urgent queries</p>
            </div>

            <h2>Business Inquiries</h2>
            <div className="info-section">
              <h3>Partnership & Collaboration</h3>
              <p>business@bookstore.com<br />For publishers, authors, and business partnerships</p>
            </div>
